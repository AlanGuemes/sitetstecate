...
export function SearchBar() {
  ...
  return (
    <div id="buscador" className="mx-auto max-w-3xl px-4 lg:px-8 mb-12">
      ...
      <form onSubmit={handleSearch} className="relative">
        <div
          className={`flex items-center gap-3 bg-card border-2 rounded-2xl px-5 py-4 shadow-sm transition-all duration-200 ${focused
